...
<body>
	...
	<form action="searchFlight">
		出发城市<input type="text" name="fromCity"> 到达城市<input type="text"
			name="arivCity"> <input type="submit" value="搜索">
	</form>
	</br>
	</br>
	...
	<table border="1">
		...
		<tr>
			<td>
				<%
					out.println(flight.getFlightNum());
				%>
			</td>
			<td>
				<%
					out.println(flight.getPrice());
				%>
			</td>
			<td>
				<%
					out.println(flight.getNumSeats());
				%>
			</td>
			<td>
				<%
					out.println(flight.getNumAvail());
				%>
			</td>
			<td>
				<%
					out.println(flight.getFromCity());
				%>
			</td>
			<td>
				<%
					out.println(flight.getArivCity());
				%>
			</td>
			<td><a
